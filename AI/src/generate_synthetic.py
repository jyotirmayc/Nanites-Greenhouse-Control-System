...
soil = np.zeros(n); soil[0]=0.35
evap_coeff = 0.0006
irrigation_liters = np.zeros(n); pump_on = np.zeros(n, dtype=int)
for i in range(1, n):
...
df.to_csv("../data/synthetic_greenhouse_7days_10min.csv", index=False)
print("Saved ../data/synthetic_greenhouse_7days_10min.csv")